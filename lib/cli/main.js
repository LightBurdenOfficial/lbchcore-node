...
function main(servicesPath, additionalServices) {
  ...
  program
    ...
    .action(function(services){
      ...
      if (!configInfo) {
        throw new Error('Could not find configuration, see `lbchcore-node create --help`');
      }
      var opts = {
      ...
      console.log();
      console.log('    $ lbchcore-node add wallet-service');
      console.log('    $ lbchcore-node add insight-api');
      console.log();
    });
  ...
  program
    ...
    .action(function(services){
      ...
      console.log('  Examples:');
      console.log();
      console.log('    $ lbchcore-node remove wallet-service');
      console.log('    $ lbchcore-node remove insight-api');
      console.log();
    });
