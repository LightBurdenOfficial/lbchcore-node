...
describe('#defaultBaseConfig', function() {
  it('will return expected configuration', function() {
    ...
    lbchd.spawn.datadir.should.equal(home + '/.lbch');
    lbchd.spawn.exec.should.equal(path.resolve(__dirname, '../../bin/lbchd'));
  });
  ...
  it('be able to specify a datadir', function() {
    ...
    info.config.servicesConfig.lbchd.spawn.datadir.should.equal('./data2');
  });
});
